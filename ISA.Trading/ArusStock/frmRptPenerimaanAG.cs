...
{
    public partial class frmRptPenerimaanAG : ISA.Controls.BaseForm
    {
        public frmRptPenerimaanAG()
        {
            InitializeComponent();
        }

        private void frmRptPenerimaanAG_Load(object sender, EventArgs e)
        {
            rangeDateBox1.FromDate = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1);
            rangeDateBox1.ToDate = DateTime.Now;
            lookupGudang1.GudangID = "";

            txtKeGud.Text = GlobalVar.Gudang;
        }
        ...
        private void cmdYes_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Isi Gudang Pengirim");
                    return;
                }
                ...
                using (Database db = new Database())
                {
                    ...
                    db.Commands.Add(db.CreateCommand("rsp_PenerimaanAntarGudangDepo"));
                    ...
                    db.Commands[0].Parameters.Add(new Parameter("@Penerima", SqlDbType.VarChar, txtKeGud.Text));
