...
{
    public partial class frmDashboardPICArea : ISA.Trading.BaseForm
    {
        DataTable dt;
        DataTable dtPs;
        DataTable dtOvd;
        ...
        private void PopulateData() 
        {
            ...
            dtPs = GetData("rsp_Dashboard_Salesman_PIC");
        }
        ...
        private void bwKADepo_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            DisplayReport(dtPs, "SalesmanPICArea", "DataPICArea");
        }       
    }
}