...
{
    public partial class frmDashboardKaDepo : ISA.Trading.BaseForm
    {
        DataTable dt;
        DataTable dtPs;
        DataTable dtOvd;
        ...
        {
            rangePeriode.FromDate = MondayBfrLastSunday(GlobalVar.DateOfServer, LastSunday(GlobalVar.DateOfServer, DayOfWeek.Sunday).DayOfWeek);
            rangePeriode.ToDate = LastSunday(GlobalVar.DateOfServer, DayOfWeek.Sunday);
        }
        ...
        private void PopulateData() 
        {
            ...
            dtPs = GetData("rsp_Dashboard_Salesman_Performance");
        ...
        private void PullDataSF() 
        {
            try
            {
                using (Database db = new Database())
                {
                    ...
                    db.Commands[0].Parameters.Add(new ISA.DAL.Parameter("@tglmulai", SqlDbType.DateTime, rangePeriode.FromDate));
        ...
        private void DisplayReport(DataTable dt, string reportVwr, string dataSet)
        {
            ...
            if (reportVwr == "SalesmanPerformance" || reportVwr == "LostSalesWalkIn" || reportVwr == "LostSalesToko")
            {
            ...
            {
                periode = rangePeriode.ToDate.Value.ToString("d MMM yyyy",
                      CultureInfo.CreateSpecificCulture("en-US"));
            }
        ...
        private void bwKADepo_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            DisplayReport(dtPs, "SalesmanPerformance", "DataPS");
