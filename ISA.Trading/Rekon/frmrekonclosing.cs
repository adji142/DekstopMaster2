...
{
    public partial class frmrekonclosing : ISA.Trading.BaseForm
    {
        #region Variables
        ...
        private ExcelPackage Process1()
        {
            ...
            #region sheet 2
                ...
                //foreach (DataRow dr1 in dtpj2bkm.Rows)
                {
                    ...
                    ws2.Cells[rowx, 8].Value = Convert.ToDouble(Tools.isNull(dtpj2bkm.Rows[i]["jmlDebit"], 0)) - Convert.ToDouble(Tools.isNull(dtpj2bkm.Rows[i]["jmlkredit"], 0));
        ...
        private void frmrekonclosing_Load(object sender, EventArgs e)
        {
            ...
            DataTable dtcektglawal = new DataTable();
                ...
                {
                    tglawaltrans = Convert.ToDateTime(dtcektglawal.Rows[0]["periode2"].ToString()).AddDays(-3);
