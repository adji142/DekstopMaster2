...
select a.nokoreksi, a.RecordID, b.recordid from KoreksiPembelian a left outer join KoreksiPembelian_PTK b on a.NoKoreksi = b.nokoreksi and a.BarangID = b.barangid
where
a.TglKoreksi >= '2011/08/01' --and '2011/09/30'
and a.RecordID like 'PTK%'
order by a.TglKoreksi

-- Ada 7 row Null semua kanannya
...
select * from KoreksiPembelian where nokoreksi = 'RJ00506'
select * from KoreksiPembelian_PTK where nokoreksi = 'RJ00506'

-- no koreksi : RJ00506, UFA0440, UFA0440, UHA0197, UFA0440, UIA0053, RJ00366
...
SELECT * FROM dbo.KoreksiPembelian_PTK a
where
a.TglKoreksi >= '2011/08/01' --and '2011/09/30'
and a.RecordID like 'PTK%'
