...
select a.nokoreksi, a.RecordID, b.recordid from KoreksiReturPembelian a left outer join KoreksiReturPembelian_MDN b on a.NoKoreksi = b.nokoreksi and a.BarangID = b.barangid
where
...
select * from KoreksiReturPembelian where nokoreksi = 'P/09-11/12'
select * from KoreksiReturPembelian_MDN where nokoreksi = 'P/09-11/12'

select * from KoreksiReturPembelian where nokoreksi = 'P/09-11/22'
select * from KoreksiReturPembelian_MDN where nokoreksi = 'P/09-11/22'

select * from KoreksiReturPembelian where nokoreksi = 'KOO3284'
select * from KoreksiReturPembelian_MDN where nokoreksi = 'KOO3284'

select * from KoreksiReturPembelian where nokoreksi = 'KOO3065'
select * from KoreksiReturPembelian_MDN where nokoreksi = 'KOO3065'

select * from KoreksiReturPembelian where nokoreksi = 'KR0221'
select * from KoreksiReturPembelian_MDN where nokoreksi = 'KR0221'
...
SELECT * FROM dbo.KoreksiReturPembelian_MDN a
where
a.TglKoreksi >= '2011/08/01' --and '2011/09/30'
and a.RecordID like 'MDN%'
