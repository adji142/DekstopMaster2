...
/****** Object:  StoredProcedure [dbo].[rsp_DOHalfACC]    Script Date: 03/09/2011 09:49:51 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	VACCDO > Laporan > DO ACC Sebagian
-- ============================================================
ALTER PROCEDURE [dbo].[rsp_DOHalfACC] 
