...
{
    public partial class frmReportViewer : ISA.Finance.BaseForm
    {
        ...
        public frmReportViewer(string reportPath, List<ReportParameter> param, DataTable data, string datasetName)
        {
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "ISA.Finance." + reportPath;
            //this.reportViewer1.LocalReport.ReportEmbeddedResource = "ISA.Finance.Communicator.rptUploadStatusToko.rdlc";
