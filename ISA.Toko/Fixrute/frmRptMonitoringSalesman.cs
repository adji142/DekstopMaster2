...
{
    public partial class frmRptMonitoringSalesman : ISA.Toko.BaseForm
    {
        DataTable dtGit,dtDOPending,dtRekap,dtDOSelese;
        ...
        public void GenerateExcellKunjungan(DataTable dtGIT, DataTable dtDOPending, DataTable dtRekap, DataTable dtDOSelese)
        {
            ...
            {
                p.Workbook.Properties.Title = "MONITORING SALES ORDER" + DateTime.Now.ToString("ddMMyyy");
                ...
                foreach (DataRow dr in dtRekap.Rows)
                {
                    ...
                    ws.Cells[idx, 4].Value = tanggalKunj;
