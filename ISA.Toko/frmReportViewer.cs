...
namespace ISA.Toko
{
    public partial class frmReportViewer : Form
    {
        ...
        public frmReportViewer(string reportPath, List<ReportParameter> param, DataTable data, string datasetName)
        {
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "ISA.Toko." + reportPath;
        ...
        private void Export(LocalReport report)
        {
            ...
            string deviceInfo =
              ...
              "  <MarginLeft>0.15in</MarginLeft>" +
              "  <MarginRight>0.15in</MarginRight>" +
              "  <MarginBottom>5.5in</MarginBottom>" +
              "</DeviceInfo>";
            Warning[] warnings;
            m_streams = new List<Stream>();
            report.Render("Image", deviceInfo, CreateStream, out warnings);
        ...
        public void Print2()
        {
            ...
            Export2(this.reportViewer1.LocalReport);
            m_currentPageIndex = 0;
            PrintDirectly();
