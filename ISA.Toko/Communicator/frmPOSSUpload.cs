...
{
    public partial class frmPOSSUpload : ISA.Toko.BaseForm
    {
        ...
        private void frmPOSSUpload_Load(object sender, EventArgs e)
        {
            ...
            chkClosingStock.Checked = false;    // true;
        }
        ...
        private void UploadStatusToko()
        {
            ...
            try
            {
                ...
                fields.Add(new Foxpro.DataStruct("idwil", "idwil", Foxpro.enFoxproTypes.Char, 1));
