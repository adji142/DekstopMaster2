...
namespace ISA.Toko.DO
{
    public partial class FrmDO2803 : ISA.Controls.BaseForm
    {
        ...
        double _hrgB = 0,_hrgM = 0,_hrgK = 0,_hrgJual = 0,_hrgAkhir = 0,_hrgHPP = 0, 
               ...
               _Het = 0,_dcash = 0, _dcash2 = 0, HrgNetto = 0;
        ...
        private void UpdateEntryDo(DataTable dt)
        {
            ...
            if (dt != null)
            {
                ...
                foreach (DataRow dr in dtAG.Rows)
                {
                    ...
                    Hitnet3d(nHjual, nDisc1, nDisc2);

                    Double nJumlah = HrgNetto * nQty;
                    ...
                    DataGridDO.Rows[nRowIndex].Cells[5].Value = Convert.ToDouble(dr["disc1"]);
                    DataGridDO.Rows[nRowIndex].Cells[6].Value = Convert.ToDouble(dr["disc2"]);
                    DataGridDO.Rows[nRowIndex].Cells[8].Value = 0;
                    DataGridDO.Rows[nRowIndex].Cells[9].Value = nJumlah;
                ...
                if (GlobalVar.Gudang != "2803")
                {
                    ...
                    for (int a = 0; a < DataGridDO.Rows.Count; ++a)
                    {
                        ...
                        if (promoFlag == string.Empty)
                        {
                            ...
                            {
                                msgBuilder.AppendLine("Harga Jual " + nama + " lebih kecil dari Harga Standar." + string.Format("{0:N0}", _hargaFinal));
                                DataGridDO.Rows[a].Cells["GvNoAcc"].Value = _noACCHarga;
                            }
                            else if (harga < _hrgHPP)
                            {
                                msgBuilder.AppendLine("Harga Jual " + nama + " lebih kecil dari Harga HPP " + string.Format("{0:N0}", _hrgHPP));
                                DataGridDO.Rows[a].Cells["GvNoAcc"].Value = _noACCHarga;
                            }
                        }
        ...
        {
            //DO.FrmBarcodeDO ifrmChild = new DO.FrmBarcodeDO(this,  lookupJenisTransaksi1.IdTr);
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    if (TxtNamaToko.Text != "ECERAN CASH")
                    {
                        if (jenis2 == "T" || jenis2 == "t")
                        {
                            ...
                            if (_Het == 0)
                            {
                                _Het = _hrgB; _dcash = 0; _dcash2 = 0;
                            }
                            Hitnet3d(_Het, _dcash, _dcash2);
                            ...
                            DataGridDO.Rows[nRowIndex].Cells[9].Value = qty * HrgNetto;
                        ...
                        if (jenis2 == "K" || jenis2 == "k")
                        {
                            if (_hrgB == 0)
                            {
                                ...
                                DataGridDO.Rows[nRowIndex].Cells[5].Value = 0;
                                DataGridDO.Rows[nRowIndex].Cells[6].Value = 0;
                                DataGridDO.Rows[nRowIndex].Cells[9].Value = qty * _hrgHppNew;
                            }
                            else
                            {
                                _hargaFinal = _hrgB;
