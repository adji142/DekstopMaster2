...
select a.nokoreksi, a.RecordID, b.recordid from KoreksiPembelian a left outer join KoreksiPembelian_MDN b on a.NoKoreksi = b.nokoreksi and a.BarangID = b.barangid
where
a.TglKoreksi >= '2011/08/01' --and '2011/09/30'
and a.RecordID like 'MDN%'
order by a.TglKoreksi

-- Ada 8 row Null semua kanannya
...
select * from KoreksiPembelian where nokoreksi = 'P/09-11/12'
select * from KoreksiPembelian_MDN where nokoreksi = 'P/09-11/12'

-- no koreksi : P/09-11/22, KOO3284, KR0221, KOO3284, KOO3065, KOO3065, KR0221
...
SELECT * FROM dbo.KoreksiPembelian_MDN a
where
a.TglKoreksi >= '2011/08/01' --and '2011/09/30'
and a.RecordID like 'MDN%'
