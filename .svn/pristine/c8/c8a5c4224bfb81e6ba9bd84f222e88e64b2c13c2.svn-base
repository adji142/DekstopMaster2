...
{
    public partial class frmRptLaporanPOS : ISA.Trading.BaseForm
    {
        public frmRptLaporanPOS()
        {
            InitializeComponent();
        }
        ...
        private void frmRptLaporanPOS_Load(object sender, EventArgs e)
        {
        ...
        private void cmdyes_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (Database db = new Database())
                {
                    ...
                    db.Commands.Add(db.CreateCommand("[rsp_cetakNotaPOS]"));
        ...
        private void DisplayReport(DataTable dt)
        {
           ...
           // rptParams.Add(new ReportParameter("UserID", SecurityManager.UserID));
            //call report viewer
            frmReportViewer ifrmReport = new frmReportViewer("Penjualan.RptPenjualanPOS.rdlc", rptParams, dt, "dsCetakLaporanHarianPOS_Data");
            ifrmReport.Show();
        }
