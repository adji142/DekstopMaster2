namespace ISA.Trading.Master
{
    partial class frmGudangUpdate
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtGudangID = new ISA.Trading.Controls.CommonTextBox();
            this.txtNamaGudang = new ISA.Trading.Controls.CommonTextBox();
            this.txtAlamat = new ISA.Trading.Controls.CommonTextBox();
            this.txtAlamat2 = new ISA.Trading.Controls.CommonTextBox();
            this.txtAlamat3 = new ISA.Trading.Controls.CommonTextBox();
            this.txtTelp = new ISA.Trading.Controls.CommonTextBox();
            this.txtFax = new ISA.Trading.Controls.CommonTextBox();
            this.txtModem = new ISA.Trading.Controls.CommonTextBox();
            this.cmdCLOSE = new ISA.Trading.Controls.CommandButton();
            this.cmdSAVE = new ISA.Trading.Controls.CommandButton();
            this.cbCabang = new ISA.Trading.Controls.CabangComboBox();
            this.SuspendLayout();
            // 
            // label1
            // 
        ...
        private ISA.Trading.Controls.CommonTextBox txtGudangID;
        private ISA.Trading.Controls.CommonTextBox txtNamaGudang;
        private ISA.Trading.Controls.CommonTextBox txtAlamat;
        private ISA.Trading.Controls.CommonTextBox txtAlamat2;
        private ISA.Trading.Controls.CommonTextBox txtAlamat3;
        private ISA.Trading.Controls.CommonTextBox txtTelp;
        private ISA.Trading.Controls.CommonTextBox txtFax;
        private ISA.Trading.Controls.CommonTextBox txtModem;
        private ISA.Trading.Controls.CommandButton cmdCLOSE;
        private ISA.Trading.Controls.CommandButton cmdSAVE;
        private ISA.Trading.Controls.CabangComboBox cbCabang;
    }
}
