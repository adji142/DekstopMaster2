...
IF OBJECT_ID('[dbo].[rsp_DOTolakACC]') IS NOT NULL
DROP PROC [dbo].[rsp_DOTolakACC] 
GO

/****** Object:  StoredProcedure [dbo].[rsp_DOTolakACC]    Script Date: 03/09/2011 09:50:15 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	VACCDO > Laporan > DO Tolak ACC
-- ============================================================
ALTER PROCEDURE [dbo].[rsp_DOTolakACC] 
