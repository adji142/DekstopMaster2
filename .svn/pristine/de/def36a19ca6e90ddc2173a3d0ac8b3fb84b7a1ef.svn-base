namespace ISA.Trading.Persediaan
{
    partial class frmRptStandarStokTipis
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tglForm = new ISA.Trading.Controls.DateTextBox();
            this.TglRequest = new ISA.Trading.Controls.DateTextBox();
        ...
        private ISA.Trading.Controls.DateTextBox tglForm;
        private ISA.Trading.Controls.DateTextBox TglRequest;
