namespace ISA.Trading.Master
{
    partial class FrmBudgetPembelianAddEdit
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dateTextBoxTmt = new ISA.Trading.Controls.DateTextBox();
            this.numericTextBoxBudget = new ISA.Trading.Controls.NumericTextBox();
        ...
        private ISA.Trading.Controls.DateTextBox dateTextBoxTmt;
        private ISA.Trading.Controls.NumericTextBox numericTextBoxBudget;
