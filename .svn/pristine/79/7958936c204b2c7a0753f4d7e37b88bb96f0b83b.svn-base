...
SELECT * INTO ISA_TokoCleanUp.dbo.TokoToSales FROM ISAdb.dbo.TokoToSales t
...
UPDATE isadb.dbo.TokoToSales 
SET KodeToko = b.KodeTokoHeader
FROM isadb.dbo.TokoToSales a inner join isadb.dbo.mappingtoko2012 b
