...
namespace ISA.Trading
{
    class GlobalVar
    {
        ...
        static string _DBFinance = ISA.Trading.Properties.Settings.Default.DBFinance;
        static bool _PS;
        static bool _KS;
        ...
        public static void GetTokoMitra()
        {
            try
            {
                using (Database db = new Database())
                {
                    db.Commands.Add(db.CreateCommand("psp_GetTokoMitra"));
