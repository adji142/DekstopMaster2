...
{
    public partial class frmTargetCollectionUpdate : ISA.Trading.BaseForm
    {
        ...
        public frmTargetCollectionUpdate(Form caller)
        {
            InitializeComponent();
        ...
        public frmTargetCollectionUpdate(Form caller, Guid RowID)
        {
            InitializeComponent();
        ...
        private void frmTargetCollectionUpdate_Layout(object sender, LayoutEventArgs e)
        {
            try
            {
                ...
                switch (formMode)
                {
                    case enumFormMode.New:
                        ...
                        using (Database db = new Database())
                        {
                            ...
                            db.Commands.Add(db.CreateCommand("usp_TargetCollection_INSERT"));
                            db.Commands[0].Parameters.Add(new Parameter("@RowID", SqlDbType.UniqueIdentifier, _RowID));
                    ...
                    case enumFormMode.Update:
                        ...
                        {
                            DataTable dt = new DataTable();
                            db.Commands.Add(db.CreateCommand("usp_TargetCollection_UPDATE"));
                            db.Commands[0].Parameters.Add(new Parameter("@RowID", SqlDbType.UniqueIdentifier, _RowID));
        ...
        private void FormClose()
        {
            ...
            {
                frmTargetCollection frmCaller = (frmTargetCollection)this.Caller;
