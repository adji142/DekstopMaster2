USE [ISAdb]
GO
/****** Object:  StoredProcedure [dbo].[rsp_ReturBeli_RegisterReturBeli]    Script Date: 10/19/2011 15:54:26 ******/
SET ANSI_NULLS ON
GO
...
-- ======================================================      
ALTER PROCEDURE [dbo].[rsp_ReturBeli_RegisterReturBeli]       
 ...
 FROM dbo.KelompokBarang k      
  ...
  (      
   SELECT      
    ...
    SUM( (dbo.fnHitungNet3Disc(     
    --v.HrgBeli   
    [dbo].[fnGetHargaBeli](v.BarangID,r.TglKeluar,'AVG')
        
    , v.Disc1, v.Disc2, v.Disc3, '' ) - v.Pot)      
