...
namespace ISA.Finance
{
    class GlobalVar
    {
        ...
        static string _DBName = ISA.Finance.Properties.Settings.Default.DbName;
        static string _DBHR = ISA.Finance.Properties.Settings.Default.DbHR;
        static DateTime _ServerDate;
        static bool _ServerXTD;

        public static bool IsXtd
        {
            get { return _ServerXTD; }
            set { _ServerXTD = value; }
        }
